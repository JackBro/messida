...
static int idaapi hook_ui(void *user_data, int notification_code, va_list va)
{
    ...
    case ui_notification_t::ui_debugger_menu_change: 
    {
        add_menu_item("Debugger/StepInto", "-", NULL, SETMENU_INS | SETMENU_CTXAPP, NULL, NULL);
        add_menu_item("Debugger/StepInto", "Execute MESS/MAME command...", NULL, SETMENU_INS | SETMENU_CTXAPP, execute_mess_cmd, NULL);
        add_menu_item("Debugger/StepInto", "-", NULL, SETMENU_INS | SETMENU_CTXAPP, NULL, NULL);
        return 1;
    }
    default:
